...
& $compiler /nologo /target:winexe /platform:anycpu /optimize+ ("/out:$output") ("/win32manifest:$manifest") ("/win32icon:$icon") ("/resource:$icon,Syncrash.Icon") ("/resource:$mark,Syncrash.Mark") ("/resource:$recipe,Syncrash.Recipe") ("/resource:$banner,Syncrash.Banner") ("/resource:$license,Syncrash.License") /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Runtime.Serialization.dll $sources
