...
El aplicador verifica la base Steam y los recursos, reconstruye el resultado en memoria y prepara un temporal junto a `gbr.exe`. Comprueba de nuevo los archivos y que el juego esté cerrado antes de sustituirlo. No crea respaldo. Si el resultado exacto ya estaba instalado, lo vuelve a escribir.
